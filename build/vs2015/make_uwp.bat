...
IF %ERRORLEVEL% NEQ 0 cmake -G "Visual Studio 16 2019" -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
...
IF %ERRORLEVEL% NEQ 0 cmake -G "Visual Studio 16 2019 Win64" -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
...
IF %ERRORLEVEL% NEQ 0 cmake -G "Visual Studio 16 2019 ARM" -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
